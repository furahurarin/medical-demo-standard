  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 space-y-12">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold">診療科目・主な対応症状</h2>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold">初めて受診される方へ（受診の流れ）</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-semibold">料金・保険について</h2>
        <p className="text-gray-700">
